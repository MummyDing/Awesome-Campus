...
public enum DrawerItem {
    ...
    LIFE(R.string.life,R.mipmap.ic_life_black), LIBRARY(R.string.library,R.mipmap.ic_library_black),
    EDUCATION(R.string.education,R.mipmap.ic_edu_black),THEME(R.string.theme,R.mipmap.ic_theme_black),
    SETTINGS(R.string.settings,R.mipmap.ic_settings_black),ABOUT(R.string.about,R.mipmap.ic_about_black),
