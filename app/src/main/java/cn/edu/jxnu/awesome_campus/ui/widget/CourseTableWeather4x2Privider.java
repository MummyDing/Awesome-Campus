 ...
 */
public class CourseTableWeather4x2Privider extends BaseWidgetPrivider {
    public static final String TAG = "CourseTableWeather4x2Privider";
    @Override
    ...
    protected void init() {
        ...
        super.object=CourseTableWeather4x2Service.class;
    }
}
